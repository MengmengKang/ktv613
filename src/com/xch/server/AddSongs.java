...
public class AddSongs extends javax.swing.JFrame
{
     ...
     * Runnable() { public void run() { AddSongs inst = new AddSongs();
    ...
    private void initGUI()
    {
        try
        {
            ...
            }
            {
                ...
                final ComboBoxModel jStarModel = new DefaultComboBoxModel(
                        StarNameList);
                jStar = new JComboBox();
    ...
    private void jChooseSongActionPerformed(final ActionEvent evt)
    {
        // System.out.println("jChooseSong.actionPerformed, event="+evt);
        // TODO add your code for jChooseSong.actionPerformed
        /*
         * ChooseSong inst = new ChooseSong(); inst.setLocationRelativeTo(null);
    ...
    private void jSongNameKeyTyped(final KeyEvent evt)
    {
    ...
    private void jSongNameKeyReleased(final KeyEvent evt)
    {
        ...
        final Chinese2Pinyin py = new Chinese2Pinyin(jSongName.getText());
