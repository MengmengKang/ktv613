...
public class EditAdmin extends javax.swing.JFrame
{
    ...
    public EditAdmin(final String indata)
    {
        super();
    ...
    private void jAddActionPerformed(final ActionEvent evt)
    {
        ...
        if (jPassword.getPassword().length == 0
                || jPasswordEnsure.getPassword().length == 0)
        {
        ...
        final String passwordEnsure = new String(jPasswordEnsure.getPassword());
