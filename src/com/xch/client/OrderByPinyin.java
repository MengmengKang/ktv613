...
public class OrderByPinyin extends javax.swing.JFrame
{
     ...
     * Runnable() { public void run() { OrderByPinyin inst = new
     * OrderByPinyin();
     * 
    ...
    private void jSearchActionPerformed(final ActionEvent evt)
    {
        ...
        final String pinyin = jPinyin.getText();
        final String[][] res = DA.orderByPinyin(pinyin, elems);
    ...
    public void setBak()
    {
        ...
        final ImageIcon img = new ImageIcon("img/p1.jpg");
