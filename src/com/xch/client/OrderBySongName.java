 ...
 */
public class OrderBySongName extends javax.swing.JFrame
{
    /**
     * 
     */
     ...
     * Runnable() { public void run() { OrderBySongName inst = new
     * OrderBySongName();
     * 
    ...
    private void initGUI()
    {
        try
        {
            ...
            }
            {
                ...
                jSongName.setBounds(145, 22, 79, 24);
            }
            {
                jLabel1 = new JLabel();
    ...
    private void jSearchActionPerformed(final ActionEvent evt)
    {
        ...
        final String SongName = jSongName.getText();
        final String[][] res = DA.orderBySongName(SongName, elems);
    ...
    public void setBak()
    {
        ...
        final ImageIcon img = new ImageIcon("img/p2.jpg");
