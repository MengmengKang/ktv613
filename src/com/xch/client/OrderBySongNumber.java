...
public class OrderBySongNumber extends javax.swing.JFrame
{
     ...
     * Runnable() { public void run() { OrderBySongNumber inst = new
     * OrderBySongNumber();
     * 
    ...
    private void jSearchActionPerformed(final ActionEvent evt)
    {
        ...
        final String str = jSongNumber.getText();
        // System.out.println("str="+str);
        int SongNumber;
        try
        {
            SongNumber = Integer.parseInt(str);
            final String[][] res = DA.orderBySongNumber(SongNumber, elems);
    ...
    public void setBak()
    {
        ...
        final ImageIcon img = new ImageIcon("img/p3.jpg");
